import {
  ...
  useLoader,
  useThree
} from "./chunk-CMYLACJO.js";
import "./chunk-C6NEOYIP.js";
import {
  require_jsx_runtime
...
function rotate(buffer2, rotation) {
  ...
  var v4 = new Vector3();
  var _defaultRotation$rota = _objectSpread2(_objectSpread2({}, defaultRotation), rotation), q2 = _defaultRotation$rota.q, center2 = _defaultRotation$rota.center;
  for (var _i5 = 0; _i5 < buffer2.length; _i5 += 3) {
    v4.set(buffer2[_i5] - center2[0], buffer2[_i5 + 1] - center2[1], buffer2[_i5 + 2] - center2[2]);
    v4.applyQuaternion(q2);
...
var perlin2 = function perlin22(x, y) {
  var X2 = Math.floor(x), Y2 = Math.floor(y);
  x = x - X2;
  y = y - Y2;
  X2 = X2 & 255;
  Y2 = Y2 & 255;
  var n00 = gradP[X2 + perm[Y2]].dot2(x, y);
  var n01 = gradP[X2 + perm[Y2 + 1]].dot2(x, y - 1);
  var n10 = gradP[X2 + 1 + perm[Y2]].dot2(x - 1, y);
  var n11 = gradP[X2 + 1 + perm[Y2 + 1]].dot2(x - 1, y - 1);
  var u = fade(x);
  return lerp(lerp(n00, n10, u), lerp(n01, n11, u), fade(y));
};
var perlin3 = function perlin32(x, y, z) {
  var X2 = Math.floor(x), Y2 = Math.floor(y), Z2 = Math.floor(z);
  x = x - X2;
  y = y - Y2;
  z = z - Z2;
  X2 = X2 & 255;
  Y2 = Y2 & 255;
  Z2 = Z2 & 255;
  var n000 = gradP[X2 + perm[Y2 + perm[Z2]]].dot3(x, y, z);
  var n001 = gradP[X2 + perm[Y2 + perm[Z2 + 1]]].dot3(x, y, z - 1);
  var n010 = gradP[X2 + perm[Y2 + 1 + perm[Z2]]].dot3(x, y - 1, z);
  var n011 = gradP[X2 + perm[Y2 + 1 + perm[Z2 + 1]]].dot3(x, y - 1, z - 1);
  var n100 = gradP[X2 + 1 + perm[Y2 + perm[Z2]]].dot3(x - 1, y, z);
  var n101 = gradP[X2 + 1 + perm[Y2 + perm[Z2 + 1]]].dot3(x - 1, y, z - 1);
  var n110 = gradP[X2 + 1 + perm[Y2 + 1 + perm[Z2]]].dot3(x - 1, y - 1, z);
  var n111 = gradP[X2 + 1 + perm[Y2 + 1 + perm[Z2 + 1]]].dot3(x - 1, y - 1, z - 1);
  var u = fade(x);
  var v4 = fade(y);
  var w = fade(z);
...
var isCamera = function isCamera2(v4) {
  return v4 && v4.isCamera;
};
var isLight = function isLight2(v4) {
  return v4 && v4.isLight;
};
...
var Ne = (0, import_react.memo)(function({ children: e, camera: t, scene: n, resolutionScale: i, enabled: o = true, renderPriority: s = 1, autoClear: c2 = true, depthBuffer: l, enableNormalPass: u, stencilBuffer: d, multisampling: p2 = 8, frameBufferType: m2 = HalfFloatType, ref: h }) {
  ...
  return (0, import_react.useImperativeHandle)(h, () => w?.composer, [w]), D ? (0, import_jsx_runtime.jsx)(G.Provider, {
    value: D,
...
function Ie({ enabled: e = false, children: t, ...n }) {
  ...
  return (0, import_react.useEffect)(() => {
    ...
    let n2 = a.current;
    a.current = t2, i((e2) => {
      let r2 = new Set(e2), i2 = new Set(t2), a5 = t2.filter((e3) => !r2.has(e3)), o = n2.filter((e3) => !i2.has(e3) && r2.has(e3));
      if (!a5.length && !o.length) return e2;
      let s = o.length ? new Set(o) : null, c2 = s ? e2.filter((e3) => !s.has(e3)) : e2;
      return a5.length ? [...c2, ...a5] : c2;
    });
  }, [
    e,
    t,
...
function Ke({ ref: e, blendFunction: t, worldFocusDistance: n, worldFocusRange: r, focusDistance: i, focusRange: a, focalLength: o, bokehScale: s, resolutionScale: c2, resolutionX: l, resolutionY: u, width: d, height: f, target: p2, depthTexture: h, ...g }) {
  let { camera: _ } = (0, import_react.use)(G), v4 = p2 != null, y = (0, import_react.useMemo)(() => {
    ...
    let p3 = e2.maskPass;
    return p3.maskFunction = MaskFunction.MULTIPLY_RGB_SET_ALPHA, e2;
  }, [
    _,
    t,
    n,
...
function Je({ target: e = void 0, mouse: n = false, debug: i = void 0, manual: o = false, smoothTime: s = 0.25, ref: c2, ...l }) {
  let u = (0, import_react.useRef)(null), f = (0, import_react.useRef)(null), p2 = (0, import_react.useRef)(null), m2 = useThree(({ scene: e2 }) => e2), g = useThree(({ pointer: e2 }) => e2), { composer: _, camera: v4 } = (0, import_react.useContext)(G), [y] = (0, import_react.useState)(() => qe(new DepthPickingPass())), [b] = (0, import_react.useState)(() => qe(new CopyPass()));
  ...
  useFrame(async (e2, t) => {
    o || w(t), f.current && f.current.position.copy(x), p2.current && u.current?.target && p2.current.position.copy(u.current.target);
  });
...
var ct = class extends Effect {
  constructor({ blendFunction: e, enabled: t, glareSize: n, lensPosition: r, screenRes: i, starPoints: a, flareSize: o, flareSpeed: s, flareShape: c2, animated: l, anamorphic: u, colorGain: d, lensDirtTexture: f, haloScale: p2, secondaryGhosts: m2, aditionalStreaks: h, ghostScale: g, opacity: _, starBurst: v4 }) {
...
var ut = ({ smoothTime: e = 0.07, blendFunction: t = 23, enabled: n = true, glareSize: i = 0.2, lensPosition: o = new Vector3(-25, 6, -60), screenRes: s = new Vector2(0, 0), starPoints: c2 = 6, flareSize: l = 0.01, flareSpeed: u = 0.01, flareShape: d = 0.01, animated: f = true, anamorphic: p2 = false, colorGain: m2 = new Color(20, 20, 20), lensDirtTexture: h = null, haloScale: g = 0.5, secondaryGhosts: _ = true, aditionalStreaks: v4 = true, ghostScale: y = 0, opacity: b = 1, starBurst: x = false }) => {
  ...
  return useFrame((t2, n2) => {
    ...
    s2 && (s2.userData?.lensflare === "no-occlusion" ? a = 0 : s2 instanceof Mesh && (s2.material.uniforms?._transmission?.value > 0.2 || s2.material._transmission && s2.material._transmission > 0.2 ? a = 0.2 : s2.material.transparent && (a = s2.material.opacity))), easing.damp(i2, "value", a, e, n2);
  }), (0, import_react.useEffect)(() => {
    if (!O?.current) return;
...
function pt({ selection: e = q, selectionLayer: t = 10, blendFunction: n, patternTexture: r, patternScale: i, edgeStrength: a, pulseSpeed: o, visibleEdgeColor: s, hiddenEdgeColor: c2, multisampling: l, resolutionScale: u, resolutionX: d, resolutionY: f, width: p2, height: m2, kernelSize: h, blur: g, xRay: _, ref: v4 }) {
...
function St({ selection: e = q, selectionLayer: t = 10, lights: n = q, inverted: r = false, ignoreBackground: i = false, luminanceThreshold: o, luminanceSmoothing: s, mipmapBlur: c2, intensity: l, radius: u, levels: d, kernelSize: f, resolutionScale: p2, width: m2, height: h, resolutionX: g, resolutionY: _, ref: v4 }) {
...
function Lt({ halfRes: t, screenSpaceRadius: n, quality: r, depthAwareUpsampling: i = true, aoRadius: o = 5, aoSamples: s = 16, denoiseSamples: c2 = 4, denoiseRadius: l = 12, distanceFalloff: u = 1, intensity: d = 1, color: f, renderMode: p2 = 0, ref: m2 }) {
